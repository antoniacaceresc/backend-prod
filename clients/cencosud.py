...
class CencosudConfig:
    ...
    CHANNEL_CONFIG = {
        "Secos": {
            ...
            "TRUCK_TYPES": {
                'paquetera':        {'cap_weight': 22500, 'cap_volume': 70000, 'max_positions': 30, 'levels': 2, 'vcu_min': 0.8, 'max_pallets': 56, 'altura_cm': 280},
                'rampla_directa':   {'cap_weight': 22500, 'cap_volume': 70000, 'max_positions': 28, 'levels': 2, 'vcu_min': 0.8, 'max_pallets': 52, 'altura_cm': 270},
                'backhaul':         {'cap_weight': 22000, 'cap_volume': 60000, 'max_positions': 26, 'levels': 2, 'vcu_min': 0.55, 'max_pallets': 52, 'altura_cm': 220},
                'backhaul_28':      {'cap_weight': 22000, 'cap_volume': 60000, 'max_positions': 28, 'levels': 2, 'vcu_min': 0.55, 'max_pallets': 56, 'altura_cm': 220}
            },
            ...
            "RUTAS_POSIBLES": {
                "normal": [
                    ...
                    {"cds": ["N641 Bodega Noviciado PYP"], "ces": ["0079"], "camiones_permitidos": ["paquetera", "rampla_directa", "backhaul", "backhaul_28"]},
                    {"cds": ["N641 Bodega Noviciado PYP"], "ces": ["0080"], "camiones_permitidos": ["paquetera", "rampla_directa", "backhaul", "backhaul_28"]},
                    {"cds": ["N641 Bodega Noviciado PYP"], "ces": ["0088"], "camiones_permitidos": ["paquetera", "rampla_directa", "backhaul", "backhaul_28"]},
                    {"cds": ["N641 Bodega Noviciado PYP"], "ces": ["0103"], "camiones_permitidos": ["paquetera", "rampla_directa", "backhaul", "backhaul_28"]},
                    {"cds": ["N641 Bodega Noviciado PYP"], "ces": ["3598"], "camiones_permitidos": ["paquetera", "rampla_directa", "backhaul", "backhaul_28"]},
                    {"cds": ["N641 Bodega Noviciado PYP"], "ces": ["8150"], "camiones_permitidos": ["paquetera", "rampla_directa", "backhaul", "backhaul_28"]},
